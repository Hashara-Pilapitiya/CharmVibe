        ...
        {stats.map((item, index) => {
          return (
            <div className='min-h-[70px] w-3/6 flex flex-col justify-center odd:border-r lg:flex-1 lg:odd:border-r lg:even:border-r lg:even:last:border-none' key={index}>
              ...
              <div className='text-2xl text-white font-semibold lg:text-4xl'>{item.value}</div>

              <div className='text-base text-white font-light max-w-[110px] mx-auto lg:text-xl'>{item.text}</div>
